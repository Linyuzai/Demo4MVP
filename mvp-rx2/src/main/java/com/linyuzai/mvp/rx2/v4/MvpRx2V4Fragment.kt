package com.linyuzai.mvp.rx2.v4
 ...
 * @author linyuzai
 */
abstract class MvpRx2V4Fragment<out T : IRx2Presenter<IRx2View<*>>> : BaseRx2V4Fragment(), IRx2View<T> {
    ...
    override fun <T> bind(o: Observable<T>, e: ActivityEvent): Observable<T> = o.apply {
        if (this@MvpRx2V4Fragment.activity is LifecycleProvider<*>)
            bindUntilEvent(this@MvpRx2V4Fragment.activity as LifecycleProvider<ActivityEvent>, e)
    }
