 ...
 * @author linyuzai
 */
abstract class BaseActivity : Activity(), UIComponent, MicroThemeChangeable, KeyboardHelper, SoftKeyboardListener {
    ...
    override fun enableKeyboardObserver() {
        mKeyboardStateChangeListener = ViewTreeObserver.OnGlobalLayoutListener {
            ...
            val heightDifference = ScreenUtil.getHeight(this@BaseActivity) - (r.bottom - r.top)
            val isKeyboardShowing = heightDifference > ScreenUtil.getHeight(this@BaseActivity) / 3
